  ...
  <div class="col-md-4 col-md-offset-4">
    <div class="well">
      ...
      <form class="form-signin" method="post" action="../login/proses-login.php">
        <h2 class="form-signin-heading text-center"><strong>APLIKASI DATA SOFTWARE ALAT</strong></h2>
        ...
        <button class="btn btn-lg btn-primary btn-block" type="submit"><i class="glyphicon glyphicon-log-in"></i> Log in</button>
      </form>

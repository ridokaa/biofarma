...
<!-- <section class="content">
  <div class="container-fluid">  
        <div class="card">
            ...
            <div class="card-body">                 
                    <!-- form start -->
                    <form method='GET'action="supplier/showbaru.php">
                       <table class="table table-striped">
                        <tr>
                        <div class="card-body">
                        <div class="form-group row bg-info">
                            <label for="level_user" class="col-sm-2 col-form-label"><h4>Data Supplier</h4></label>
                            <div class="col-sm-10">
                            </div>
                        </div>
                        ...
                        <div class="form-group row bg-info">
                            <label for="kode_supplier" class="col-sm-2 col-form-label"><h4>Riwayat Input User</h4></label>
                            <div class="col-sm-10">
                            </div>
                        </div>
                            <div class="form-group row">

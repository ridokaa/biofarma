...
$query = "INSERT INTO supplier (kode_supplier, nama_supplier,alamat,kota,telepon,kode_kontak,catatan,user_update,user_edit)  VALUES ('$kode_supplier', '$nama_supplier', '$alamat', '$kota','$telepon','$kode_kontak','$catatan','$user_update','$user_edit')";

...
<!-- Main content -->
<?php 
    include('data_index_supplier.php');
?>
  ...
  <div class="container-fluid">  
        <div class="card">
            ...
            <div class="card-header bg-info">
                <h1 class="card-title">Data Suppleir di Biofarma</h1>
            </div>
            
            <div class="card-body">
                <a href="index.php?page=supplier_tambah&& kode_supplier"><i class="nav-icon  fas   fa-plus-square "></i>Tambah Data</a></button>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <ul class="dropdown-menu pull-right" role="menu" bg-dark>
                                            <li>
                                            <a href="index.php?page=supplier_detail&&kode_supplier=<?php echo $user['kode_supplier'] ?>">
                                            <i class="nav-icon  fas fa-folder-open"></i> Detail</a>
                                             </li>

                                            <li class="divider"></li>
                                            <li>
                                            <a href="index.php?page=supplier_edit&&kode_supplier=<?php echo $user['kode_supplier'] ?>">
                                            ...
                                            <a href="#" onClick="confirm_modal('supplier/delete_supplier.php?&kode_supplier=<?php echo  $user['kode_supplier'] ?>');">
                                              <i class="nav-icon  fas  fa-remove"></i> Hapus
                                        </a>
                                            </li>
                                        </ul>
   ...
   <div class="modal fade" id="modal_delete">
        <div class="modal-dialog modal-lg">
            ...
            <h4 class="modal-title"><i class="nav-icon fas   fa-times-circle"></i>Anda yakin akan menghapus data ini.. ?</h4>
                ...
                <div class="modal-footer">
                    <a href="supplier/delete_supplier.php?&kode_kontak=<?php echo  $user['kode_supplier'] ?>">

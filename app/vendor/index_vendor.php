  ...
  <div class="container-fluid">  
        <div class="card">
            ...
            <div class="card-header bg-info">
                <h1 class="card-title">Data Vendor di Biofarma</h1>
            </div>
            
            <div class="card-body">
                <a href="index.php?page=vendor_tambah&& kode_vendor"><i class="nav-icon  fas   fa-plus-square "></i>Tambah Data</a></button>
                        ...
                        <tbody>
                            <?php foreach ($data_user as $user) : ?>
                                <tr>
                                    ...
                                    <td><?php echo $user['kode_vendor'] ?></td>
                                    ...
                                    <td>
                                        ...
                                        <ul class="dropdown-menu pull-right" role="menu" bg-dark>
                                            <li>
                                            <a href="index.php?page=vendor_detail&&kode_vendor=<?php echo $user['kode_vendor'] ?>">
                                            <i class="nav-icon  fas fa-folder-open"></i> Detail</a>
                                             </li>

                                            <li class="divider"></li>
                                            <li>
                                            <a href="index.php?page=vendor_edit&&kode_vendor=<?php echo $user['kode_vendor'] ?>">
                                            ...
                                            <a href="#" onClick="confirm_modal('vendor/delete_vendor.php?&kode_vendor=<?php echo  $user['kode_vendor'] ?>');">
                                              <i class="nav-icon  fas  fa-remove"></i> Hapus
                                        </a>
                                            </li>
                                        </ul>
   ...
   <div class="modal fade" id="modal_delete">
        <div class="modal-dialog modal-lg">
            ...
            <h4 class="modal-title"><i class="nav-icon fas   fa-times-circle"></i>Anda yakin akan menghapus data ini.. ?</h4>
                ...
                <div class="modal-footer">
                    <a href="vendor/delete_vendor.php?&kode_vendor=<?php echo  $user['kode_vendor'] ?>">

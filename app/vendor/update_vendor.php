...
$query = "UPDATE vendor SET nama_vendor='$nama_vendor',alamat='$alamat', kota='$kota', telepon='$telepon', kode_kontak='$kode_kontak', catatan='$catatan', email='$email', web='$web'  WHERE kode_vendor='$kode_vendor'";

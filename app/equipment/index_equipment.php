    <!-- Content Header (Page header) -->
        <!-- Main content -->
        <?php 
    include('data_index_equipment.php');
    //include('tambah_data.php');
?>                   
<!-- <form action="departemen/store.php" method="post">
 -->    <div class="card">
        <div class="card-header bg-info">
            <h1 class="card-title">Data Equipment di Bio Farma</h1>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
            <!-- /.tombol + -->
                    ...
                    <tbody>
                        <?php foreach ($data_user as $user) : ?>
                            <tr>
                                ...
                                <td><?php echo $user['kode_equipment'] ?></td>
                                <td><?php echo $user['nama_equipment'] ?></td>
                                ...
                                <td>
                                    ...
                                    <ul class="dropdown-menu pull-right" role="menu" bg-dark>
                                        <li>
                                        <a href="index.php?page=equipment_detail&& kode_equipment=<?php echo $user['kode_equipment']; ?>">
                                        <i class="nav-icon  fas fa-folder-open"></i> Detail</a>
                                        </li>

                                        <li class="divider"></li>
                                        <li>
                                        <a href="index.php?page=equipment_edit&& kode_equipment=<?php echo $user['kode_equipment']; ?>"> 
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header bg-info">
              <h4 class="modal-title">Input Data Equipment</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <form class="form-horizontal" method="get" action="equipment/tambah_data_equipment.php">
            <div class="modal-body">
                    ...
                    <!-- form start -->
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <input type="text" class="form-control" id="kode_equipment" placeholder="kode equipment" name="kode_equipment">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="nama_equipment" class="col-sm-2 col-form-label">Nama Equipment</label>
                            <div class="col-sm-10">
                            <input type="text" class="form-control" id="nama_equipment" placeholder="nama_equipment" name="nama_equipment">
                            </div>
                        </div>
                        <div class="form-group row">

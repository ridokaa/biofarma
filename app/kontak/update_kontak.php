...
$query = "UPDATE kontak SET nama_kontak='$nama_kontak',alamat='$alamat', kota='$kota', telepon='$telepon', hp='$hp', catatan='$catatan', email='$email'  WHERE kode_kontak='$kode_kontak'";

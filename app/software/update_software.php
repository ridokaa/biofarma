...
$query = "UPDATE software SET kode_software='$kode_software',nama_software='$nama_software',kode_vendor='$kode_vendor', jenis_software='$jenis_software' WHERE id_software='$id_software'";
